...
const linksByRole: Record<DashboardRole, SidebarLink[]> = {
  admin: [
    ...
    { label: 'Leads CRM', path: '/dashboard/admin/leads', icon: 'phone' },
  ...
  student: [
    ...
    { label: 'Payments', path: '/dashboard/student/payments', icon: 'award' },
  ...
  teacher: [
    ...
    { label: 'Schedule', path: '/dashboard/teacher/schedule', icon: 'calendar' },
